...
/**
 * Generated proxy for an entry of the ImageStyle model
 * 
 * NOTE: Do not edit this class
 */
class ImageStyleEntryProxy extends ImageStyleEntry implements EntryProxy {

    /**
     * Instance of the ImageStyle model
    ...
    /**
     * Construct a new ImageStyle entry proxy
     * @param \ride\library\orm\model\Model $model Instance of the ImageStyle model
    ...
    /**
     * Loads the values of the properties of this ImageStyle entry
     * @return null
     */
    ...
    /**
     * Loads the value of a relation field of this ImageStyle entry
    ...
    public function setTransformations(array $transformations = array()) {
        $this->loadedFields['transformations'] = true;
        
        return parent::setTransformations($transformations);
    }
    ...
    public function getTransformations() {
        if (!isset($this->loadedFields['transformations'])) {
            $this->loadRelation('transformations');
        }
