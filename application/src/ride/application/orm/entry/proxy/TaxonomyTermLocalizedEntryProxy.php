...
use ride\application\orm\entry\TaxonomyTermLocalizedEntry;
use ride\application\orm\model\TaxonomyTerm;
use ride\library\orm\entry\EntryProxy;
use ride\library\orm\model\Model;

/**
 * Generated proxy for an entry of the TaxonomyTermLocalized model
 * 
 * NOTE: Do not edit this class
 */
class TaxonomyTermLocalizedEntryProxy extends TaxonomyTermLocalizedEntry implements EntryProxy {

    /**
     * Instance of the TaxonomyTermLocalized model
    ...
    /**
     * Construct a new TaxonomyTermLocalized entry proxy
     * @param \ride\library\orm\model\Model $model Instance of the TaxonomyTermLocalized model
    ...
    /**
     * Loads the values of the properties of this TaxonomyTermLocalized entry
     * @return null
     */
    ...
    /**
     * Loads the value of a relation field of this TaxonomyTermLocalized entry
