...
/**
 * Generated proxy for an entry of the Tonic model
 * 
 * NOTE: Do not edit this class
 */
class TonicEntryProxy extends TonicEntry implements EntryProxy {

    /**
     * Instance of the Tonic model
    ...
    /**
     * Construct a new Tonic entry proxy
     * @param \ride\library\orm\model\Model $model Instance of the Tonic model
    ...
    /**
     * Loads the values of the properties of this Tonic entry
     * @return null
     */
    ...
    /**
     * Loads the value of a relation field of this Tonic entry
