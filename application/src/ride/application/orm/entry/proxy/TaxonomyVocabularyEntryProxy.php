...
/**
 * Generated proxy for an entry of the TaxonomyVocabulary model
 * 
 * NOTE: Do not edit this class
 */
class TaxonomyVocabularyEntryProxy extends TaxonomyVocabulary implements EntryProxy {

    /**
     * Instance of the TaxonomyVocabulary model
    ...
    /**
     * Construct a new TaxonomyVocabulary entry proxy
     * @param \ride\library\orm\model\Model $model Instance of the TaxonomyVocabulary model
    ...
    /**
     * Loads the values of the properties of this TaxonomyVocabulary entry
     * @return null
     */
    ...
    /**
     * Loads the value of a relation field of this TaxonomyVocabulary entry
