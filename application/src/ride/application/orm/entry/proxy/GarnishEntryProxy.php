...
/**
 * Generated proxy for an entry of the Garnish model
 * 
 * NOTE: Do not edit this class
 */
class GarnishEntryProxy extends GarnishEntry implements EntryProxy {

    /**
     * Instance of the Garnish model
    ...
    /**
     * Construct a new Garnish entry proxy
     * @param \ride\library\orm\model\Model $model Instance of the Garnish model
    ...
    /**
     * Loads the values of the properties of this Garnish entry
     * @return null
     */
    ...
    /**
     * Loads the value of a relation field of this Garnish entry
