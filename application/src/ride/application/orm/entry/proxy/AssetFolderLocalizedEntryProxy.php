...
use ride\application\orm\entry\AssetFolderLocalizedEntry;
use ride\library\orm\entry\EntryProxy;
use ride\library\orm\model\Model;

/**
 * Generated proxy for an entry of the AssetFolderLocalized model
 * 
 * NOTE: Do not edit this class
 */
class AssetFolderLocalizedEntryProxy extends AssetFolderLocalizedEntry implements EntryProxy {

    /**
     * Instance of the AssetFolderLocalized model
    ...
    /**
     * Construct a new AssetFolderLocalized entry proxy
     * @param \ride\library\orm\model\Model $model Instance of the AssetFolderLocalized model
    ...
    /**
     * Loads the values of the properties of this AssetFolderLocalized entry
     * @return null
     */
    ...
    /**
     * Loads the value of a relation field of this AssetFolderLocalized entry
    ...
    /**
     * @param \ride\application\orm\asset\entry\AssetFolderEntry $entry 
     * @return null
     */
    public function setEntry(AssetFolderEntry $entry = NULL) {
        $hasOldValue = false;
        $oldValue = null;
