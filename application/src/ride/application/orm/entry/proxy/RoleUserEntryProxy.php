...
use ride\application\orm\entry\RoleUserEntry;
...
/**
 * Generated proxy for an entry of the RoleUser model
 * 
 * NOTE: Do not edit this class
 */
class RoleUserEntryProxy extends RoleUserEntry implements EntryProxy {

    /**
     * Instance of the RoleUser model
    ...
    /**
     * Construct a new RoleUser entry proxy
     * @param \ride\library\orm\model\Model $model Instance of the RoleUser model
    ...
    /**
     * Loads the values of the properties of this RoleUser entry
     * @return null
     */
    ...
    /**
     * Loads the value of a relation field of this RoleUser entry
