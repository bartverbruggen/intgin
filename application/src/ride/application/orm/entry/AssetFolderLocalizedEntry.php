...
/**
 * Generated entry for the AssetFolderLocalized model
 * 
 * NOTE: Do not edit this class directly, define your own and extend from this one.
 */
class AssetFolderLocalizedEntry extends GenericEntry {
    ...
    public function __toString() {
        return 'AssetFolderLocalized #' . $this->getId();
    }
     ...
     * @return null
     */
    public function setEntry(AliasAssetFolderEntry $entry = NULL) {
        $isClean = false;
